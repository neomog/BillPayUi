...
import TrainGridMain from "../trainGrid/TrainGridMain";
import {
  blogGridMain,
  carGridMain,
  hotelGridMian,
...
const BlocksGridMain = () => {
  return (
    <BlockMain>
      <div className="common__body overflow-x-hidden">
        <h2 className="cmn__title">Inner Grid Page</h2>
        {/* home one */}
