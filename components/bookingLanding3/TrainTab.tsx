...
import trainshape1 from "/public/img/bookbanner/trainshape1.png";
            ...
            <div className="booking__radio justify-content-center mb__30">
              <div className="b__radio">
                <input
                  ...
                  defaultChecked
                />
                <label className="form-check-label" htmlFor="bradios1s300">
                  One Way
                </label>
              </div>
              <div className="b__radio">
                <input
                  ...
                  id="bradios2s30"
                />
                <label className="form-check-label" htmlFor="bradios2s30">
                  Round Trip
                </label>
              </div>
            </div>
