...
import AirtimeRechargePaymentbox from "../common/AirtimeRechargePaymentbox";
import PaymentSponsorSlider from "../slider/PaymentSponsorSlider";
import cardhero from "/public/img/banner/cardhero.jpg";
          ...
          <div className="row g-4 justify-content-center">
            <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-6">
              <div className="recharge__paymentbox">
                ...
                <AirtimeRechargePaymentbox title="Airtime Recharge" />
              </div>
            </div>
