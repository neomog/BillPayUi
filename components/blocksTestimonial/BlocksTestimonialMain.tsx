...
import HomeTestimonialSlider from "../slider/HomeTestimonialSlider";
import HomeTwoTestimonialSlider from "../slider/HomeTwoTestimonialSlider";
import {
  ...
  return (
    <BlockMain>
      <div className="common__body overflow-x-hidden">
        <h2 className="cmn__title">Testimonial</h2>
        ...
        <div className="common__body__section pb__60">
          ...
          <div className="tab-content" id="pills-tabContentre">
            ...
            >
              {/* @TODO:Content */}
              <Code code={homeTestimonialSlider} />
            </div>
          </div>
        </div>
        ...
        <div className="common__body__section">
          ...
          <div className="tab-content" id="pills-tabContent">
            ...
            >
              {/* @TODO:Content */}
              <Code code={homeTwoTestimonialSlider} />
            </div>
          </div>
        </div>
        ...
        <div className="common__body__section pb__60">
          ...
          <div className="tab-content" id="pills-tabContent3">
            ...
            >
              <section className="testimonial__section__three overflow-hidden pt-120 pb-120">
                <Testimonial />
              </section>
            </div>
            <div
