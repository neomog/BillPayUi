...
import TrainListMain from "../trainList/TrainListMain";
import {
  blogListMain,
  busListMain,
  cartListMain,
...
const BlocksListMain = () => {
  return (
    <BlockMain>
      <div className="common__body overflow-x-hidde">
        <h2 className="cmn__title">Inner list Page</h2>
        {/* home one */}
