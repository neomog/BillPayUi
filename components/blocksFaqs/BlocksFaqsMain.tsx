...
import { faq, faqs } from "./code";

const BlocksFaqsMain = () => {
  return (
    <BlockMain>
      <div className="common__body overflow-x-hidden">
        <h2 className="cmn__title">Faqs</h2>
        ...
        <div className="common__body__section">
          ...
          <div className="tab-content" id="pills-tabContenttahir">
            <div
              className="tab-pane fade show active"
